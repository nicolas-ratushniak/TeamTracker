...
public class TeamCreateDto
{
    ...
    [RegularExpression(@"^[A-Z]([\s\-]?[a-zA-Z\d])*$", ErrorMessage = "Origin City can only contain letters, digits and \"-\". It should start with a capital letter and end with no space")]
